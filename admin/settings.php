...
<head>
    ...
    <title>Settings | NU SA System</title>
    <style>
        :root {
            --bg: #f8fafc;
            --white: #ffffff;
...
<div class="shell">
    <aside class="sidebar">
        ...
        <div class="footer">
            <a class="active" href="settings.php" aria-current="page">Settings</a>
    ...
    <main class="main">
        <header class="top">
            <div>
                <div style="font-size:24px;font-weight:800;">Settings</div>
        ...
        <section class="content">
            <div class="card">
                ...
                <p class="hint" style="margin:0;">This page is now available in the sidebar on all core admin modules, so navigation stays consistent system-wide.</p>
            </div>
        </section>
    </main>
</div>
